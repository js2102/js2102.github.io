...
<CodeBlock>$ ssh-keygen -t rsa -b 4096 -C "example@example.com"</CodeBlock>
...
<CodeBlock>
  $ ls
  <br />
  authorized_keys2 id_dsa known_hosts config
  <TextHighlight color="#7D9D9C" paddingX={24}>/* 기존 */</TextHighlight>
  <br />
  id_rsa_campany.pub id_rsa_personal.pub id_rsa_campany id_rsa_personal
  <TextHighlight color="#7D9D9C" paddingX={24}>/* 추가 */</TextHighlight>
  <br />
</CodeBlock>
...
<CodeBlock>$ cat ~/.ssh/id_rsa_personal.pube</CodeBlock>
...
User git <br />
IdentityFile ~/.ssh/id_rsa_personal <br /><br />
# company <br />
Host gitlab.회사.com <br />
HostName gitlab.com <br />
User git <br />
...
[user] <br />
  ...
  &nbsp; name = example <br />
[includeIf "gitdir:~/회사 디렉토리 경로/"] <br />
...
includeif.gitdir:~/회사 디렉토리/.path=.gitconfig-company <br />
user.email=example@example.회사.com <br />
