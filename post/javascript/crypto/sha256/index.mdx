...
import sha2561 from "./image/sha256-1.png";
import sha2562 from "./image/sha256-2.png";
...
- 충돌 저항성(Must withstand collisions)
  - 충돌이 잘 일어나지 않는다.
  - 충돌이란 두 개 이상의 해시 함수의 결과값(다이제스트)이 동일한 경우를 말한다.
