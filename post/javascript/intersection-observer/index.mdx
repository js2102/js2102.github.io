...
- IntersectionObserverEntry의 배열로 되어 있고 각 객체는 <Highlight>time</Highlight>, <Highlight>rootBounds</Highlight>, <Highlight>isVisible</Highlight> 등의 속성들을 포함한다.
- 이 중에서 중요한 속성들은 다음과 같다.
  - <Highlight color="#FFBC97">boundingClientRect</Highlight>: 관찰 대상의 사각형 정보
  - <Highlight color="#FFBC97">intersectionRect</Highlight>: 관찰 대상의 교차한 영역 정보
  - <Highlight color="#FFBC97">intersectionRatio</Highlight>: 관찰 대상의 교차한 영역 백분율
  - <Highlight color="#FFBC97">isIntersecting</Highlight>: 관찰 대상의 교차 상태(Boolean)
  - <Highlight color="#FFBC97">target</Highlight>: 관찰 대상 요소(Element)
